...
class CustomRoomPresetsConfig:
    pass


class CustomRoomPresets:
    def __init__(self, config: CustomRoomPresetsConfig, api: ModuleApi):
        # Keep a reference to the config and Module API
        self._api = api
        self._config = config

    @staticmethod
    def parse_config(config: Dict[str, Any]) -> CustomRoomPresetsConfig:
        ...
        #
        return CustomRoomPresetsConfig()
